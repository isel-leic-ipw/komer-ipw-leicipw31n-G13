...
export default function (services){
    ...
    app.get('/user/create', handlerWrapper(createUserForm))                             //Creates a form to create a new user
    ...
    async function createUserForm(req, res){
        res.render('createUserForm', {title: `Create a new user`})
    }

    async function createUser(req, res){
        const user = await services.createUser(req.body.username)
